...
import { ShareIntakeProvider } from "@/components/share/ShareIntakeProvider";
      ...
      <ShareIntentProvider>
        <GestureHandlerRootView style={{ flex: 1, backgroundColor: colors.background }}>
          ...
          >
            ...
            <Stack.Screen name="try-next/[bookmarkId]" options={{ headerShown: true, title: "Try Next" }} />
            <Stack.Screen
              name="share-import"
              options={{
                headerShown: true,
                title: "Import to PickyBites",
                presentation: "modal",
